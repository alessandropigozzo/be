package com.alessandro.keycloak;

import com.alessandro.keycloak.entity.Employee;
import com.alessandro.keycloak.service.EmployeeService;
...
public class SpringBootKeycloakExampleApplication {
    ...
    //questo metodo è per il ruolo user
    ...
    //questo metodo è solo per il ruolo admin
    @GetMapping
    @RolesAllowed("admin")
